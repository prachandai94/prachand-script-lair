...
export const PreFooterCTA = () => {
  return <section className="py-12 sm:py-16 border-t border-paper-border bg-background-secondary/50">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex-shrink-0 order-2 md:order-3 w-full md:w-auto">
            <Button variant="samurai" size="lg" onClick={() => window.open("https://www.prachandentertainment.com/", "_blank")} className="group w-full md:w-auto px-8 sm:px-10 lg:px-12 py-3 sm:py-4 text-base sm:text-lg">
