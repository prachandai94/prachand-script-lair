...
export const Footer = () => {
  ...
  return <footer className="bg-background border-t border-glass-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              return <a key={social.label} href={social.href} className="text-text-muted hover:text-samurai-red transition-colors" aria-label={social.label}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <a href="mailto:scripts@prachandentertainment.com" className="text-text-secondary hover:text-samurai-red transition-colors block">
        ...
        <div className="border-t border-glass-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-text-muted text-sm">
            A division of{" "}
            <a href="https://www.prachandentertainment.com/" target="_blank" rel="noopener noreferrer" className="text-samurai-red hover:underline">
