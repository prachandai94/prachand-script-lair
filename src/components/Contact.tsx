      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-samurai-red/10 hover:bg-samurai-red text-samurai-red hover:text-white flex items-center justify-center transition-colors duration-300" aria-label="Instagram">
              <Instagram size={18} />
            </a>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="paper rounded-2xl p-8 space-y-6">
            ...
            {/* WhatsApp Button */}
            <a href="https://wa.link/n0sna9" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 h-12 text-base font-semibold text-white bg-[#25D366] hover:bg-[#128C7E] rounded-lg transition-all duration-200 hover:scale-[1.02] shadow-lg hover:shadow-xl">
